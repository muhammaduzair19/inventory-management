...
const getExpensesByCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCategorySummary = expenseByCategorySummaryRaw.map((expense) => (Object.assign(Object.assign({}, expense), { amount: expense.amount.toLocaleString() })));
        res.status(200).json(expenseByCategorySummary);
    }
    catch (error) {
        res.status(500).json({ message: 'Error while expense by category' });
    }
});
