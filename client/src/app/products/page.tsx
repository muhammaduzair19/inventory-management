...
const Products = () => {
    ...
    if (isError || !products) {
        return <div className="text-center text-red-500 py-4" >Failed to fecth data ...</div>
    }


    return (
        <>
            <PageTitle title="Products - Inventory Management" />
            <div className='mx-auto pb-5 w-full'>
                {/* SEARCH BAR  */}
                <div className='mb-6'>
                    <div className='flex items-center border-2 border-gray-200 rounded'>
                        <SearchIcon className='w5 h-5 text-gray-500 m-2' />
                        <input
